function HeaderComponent(){
    ...
    headerDiv.setAttribute("class","container-fluid bg-light");
    headerDiv.setAttribute("style","height:70px;");
    
    var innerHeaderDiv = document.createElement("div");
    innerHeaderDiv.setAttribute("class","row");
    ...
    imgElement.setAttribute("style","width:200px;height:65px;");
    logoDiv.appendChild(imgElement);
    innerHeaderDiv.appendChild(logoDiv);

    // Creating Search Input
    var searchDiv = document.createElement("div");
    searchDiv.setAttribute("class","col-md-8 d-flex justify-content-center align-items-center");
    searchDiv.setAttribute("style","height:70px;");
    var searchInput = document.createElement("input");
    searchInput.setAttribute("type","text");
    searchInput.setAttribute("placeholder","search product");
    searchInput.setAttribute("style","width:500px; height:35px;");
    searchInput.setAttribute("id","search");
    searchDiv.appendChild(searchInput);
    innerHeaderDiv.appendChild(searchDiv);
 
    // Createing Options

    var menuDiv = document.createElement("div");
    menuDiv.setAttribute("style","height:70px");
    menuDiv.setAttribute("class","col-md-2 d-flex justify-content-around align-items-center");
    menuDiv.setAttribute("id","menu-div");
    if(sessionStorage.getItem("isLoggedIn")){
      menuDiv.innerHTML = "";
      var viewCartLable = document.createElement("label");
      viewCartLable.innerText = "View cart";
      viewCartLable.setAttribute("style","cursor:pointer");
      
      menuDiv.appendChild(viewCartLable);

      var signOutLable = document.createElement("label");
      signOutLable.innerText = "Sign out";
      signOutLable.setAttribute("style","cursor:pointer");
      
      menuDiv.appendChild(signOutLable);   
    }
    else{
      menuDiv.innerHTML = "";
      var signInLabel = document.createElement("label");
      signInLabel.innerText = "Sign In";
      signInLabel.setAttribute("style","cursor:pointer");
      signInLabel.addEventListener("click",()=>{
        mainDiv.removeChild(document.querySelector("#card-container"));
        SignInComponent(mainDiv);
      });
      menuDiv.appendChild(signInLabel);

      var signUpLabel = document.createElement("label");
      signUpLabel.innerText = "Sign up";
      signUpLabel.setAttribute("style","cursor:pointer");
      ...
      menuDiv.appendChild(signUpLabel);
    }
    innerHeaderDiv.appendChild(menuDiv); 
    
    headerDiv.appendChild(innerHeaderDiv);
    mainDiv.appendChild(headerDiv);
}
function SignUpComponent(mainDiv){
    var container = document.createElement("div");
    container.setAttribute("style","width:30%; height: 200px;position:absolute;top:50%; left:50%; transform: translate(-50%,-50%); box-shadow: 10px 10px 10px grey");
    
    var emailInput = document.createElement("input");
    emailInput.setAttribute("type","email");
    emailInput.setAttribute("class","form-control mt-4");
    ...
    signUpButton.setAttribute("class","btn btn-secondary mt-4");
    ...
    signUpButton.addEventListener("click",()=>{
      ...
      var status = userList.find((user)=>{return user.email == email && user.password==password});
      if(status)
...
function SignInComponent(mainDiv){
  var container = document.createElement("div");
  container.setAttribute("style","width:30%; height: 200px;position:absolute;top:50%; left:50%; transform: translate(-50%,-50%); box-shadow: 10px 10px 10px grey");
  ...
  signInButton.setAttribute("class","btn btn-secondary mt-4");
  ...
  signInButton.addEventListener("click",()=>{
    ...
    if(user){
      ...
      CreateCardContainerComponent(getProductList());
    }
    else{
...
function CreateCardContainerComponent(data){
  var mainDiv = document.querySelector("#main");
  var cardContainer = document.createElement("div");
  cardContainer.setAttribute("class","container-fluid mt-3");
  cardContainer.setAttribute("id","card-container");

  var cardInnerDivRow = document.createElement("div");
  cardInnerDivRow.setAttribute("class","d-flex justify-content-around flex-wrap");
  cardInnerDivRow.setAttribute("style","width:100%; row-gap:10px;");
  for(var product of data){
    var card = document.createElement("div");
    card.setAttribute("style","width: 30%; height: 370px; border: 1px solid black");
    card.setAttribute("class","d-flex flex-column");
